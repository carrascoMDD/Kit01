...
public  class KitEnumeratedValueBase 
   extends com.dosmil_e.kit.core.model.common.impl.KitCommonImpl
    implements com.dosmil_e.kit.core.model.structural.ifc.KitEnumeratedValueIfc   {
...
/****************************************************************************
 *  State storage for Attributes of the KitEnumeratedValue metamodel element
 ****************************************************************************/



/****************************************************************************
 *  State storage for the Relationships of the KitEnumeratedValue metamodel element
 ****************************************************************************/
	protected com.dosmil_e.kit.core.model.structural.ifc.KitAbstractEnumeratedTypeIfc vrType; 
...
/****************************************************************************
 *  Constructors of the KitEnumeratedValue metamodel element
 ****************************************************************************/

  public KitEnumeratedValueBase() {
    super();
  }


  public KitEnumeratedValueBase( EAIMMCtxtIfc theCtxt) {
    super( theCtxt);
  }

  public KitEnumeratedValueBase( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theName) {
    super( theCtxt, theName);
  }


/****************************************************************************
 *  Implementation of the KitEnumeratedValueIfc and KitEnumeratedValuePriv interfaces
 ****************************************************************************/

/****************************************************************************
 *  Implementation of attributes of KitEnumeratedValue
 ****************************************************************************/
...
/****************************************************************************
 *  Implementation of relationships of KitEnumeratedValue
 ****************************************************************************/

 

/****************************************************************************
 *  Implementation of public interface for ONE relationship Type
 ****************************************************************************/
  ...
  public com.dosmil_e.kit.core.model.structural.ifc.KitAbstractEnumeratedTypeIfc getType( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType == null) { return null;}

    try { return (com.dosmil_e.kit.core.model.structural.ifc.KitAbstractEnumeratedTypeIfc)
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType).
  ...
  public int numType( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType == null) { return  0;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType).
  ...
  public com.dosmil_e.kit.core.model.structural.ifc.KitAbstractEnumeratedTypeIfc findTypeNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    try {
      return (com.dosmil_e.kit.core.model.structural.ifc.KitAbstractEnumeratedTypeIfc)
        ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType).
  ...
  public boolean hasTypeNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType == null) { return  false;}
  ...
  public boolean hasType( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.structural.ifc.KitAbstractEnumeratedTypeIfc theType) throws EAIException {
    ...
    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType).
          hasRelatedElement( theCtxt, this, theType);
    } catch( ClassCastException anEx) { return false;}
  }
  ...
  public int indexOfType( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.structural.ifc.KitAbstractEnumeratedTypeIfc theType) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType == null) { return  -1;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType).
          indexOfRelatedElement( theCtxt, this, theType);
  ...
  public void setType( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.structural.ifc.KitAbstractEnumeratedTypeIfc theType) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType == null) { return;}

    try {
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.vm3RelType).
        setRelatedElement( theCtxt, this, theType);
...
/****************************************************************************
 *  Implementation of destructor of KitEnumeratedValue
 ****************************************************************************/
 ...
 ****************************************************************************/
  public static com.dosmil_e.m3.core.ifc.M3TypeIfc getStaticM3Type( EAIMMCtxtIfc theCtxt) {
    if( vm3Type == null) {
      vm3Type = com.dosmil_e.kit.core.model.structural.meta.KitEnumeratedValueMeta.getStaticM3Type( theCtxt);
    }
    return vm3Type;
  }
