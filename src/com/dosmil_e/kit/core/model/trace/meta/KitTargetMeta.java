 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("Target"));
		...
		vm3RelTransformations = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("transformations"));
		vm3Type.addRelationships( theCtxt, vm3RelTransformations);
		vm3RelTransformations.setKind( theCtxt, "Aggregates");
		vm3RelTransformations.setMinMult( theCtxt, "0");
		vm3RelTransformations.setMaxMult( theCtxt, "*");
		vm3RelTransformations.setIsDerived( theCtxt, false);
		vm3RelTransformations.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelTransformations.setInverse( theCtxt, com.dosmil_e.kit.core.model.trace.meta.KitTransformationMeta.vm3RelTarget);
		vm3RelTransformations.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.trace.meta.KitTransformationMeta.vm3Type);
