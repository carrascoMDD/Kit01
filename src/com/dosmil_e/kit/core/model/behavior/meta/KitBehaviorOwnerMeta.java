...
public  class KitBehaviorOwnerMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("BehaviorOwner"));
		...
		vm3RelOwnedBehaviors = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedBehaviors"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedBehaviors);
		vm3RelOwnedBehaviors.setKind( theCtxt, "Aggregates");
		vm3RelOwnedBehaviors.setMinMult( theCtxt, "0");
		vm3RelOwnedBehaviors.setMaxMult( theCtxt, "*");
		vm3RelOwnedBehaviors.setIsDerived( theCtxt, false);
		vm3RelOwnedBehaviors.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedBehaviors.setInverse( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitBehaviorMeta.vm3RelBehaviorOwner);
		vm3RelOwnedBehaviors.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitBehaviorMeta.vm3Type);
