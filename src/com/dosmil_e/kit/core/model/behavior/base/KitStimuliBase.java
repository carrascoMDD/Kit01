...
public  class KitStimuliBase 
   extends com.dosmil_e.kit.core.model.structural.impl.KitInfoTypeOwnerImpl
    implements com.dosmil_e.kit.core.model.behavior.ifc.KitStimuliIfc   {
...
/****************************************************************************
 *  State storage for Attributes of the KitStimuli metamodel element
 ****************************************************************************/



/****************************************************************************
 *  State storage for the Relationships of the KitStimuli metamodel element
 ****************************************************************************/
	protected com.dosmil_e.kit.core.model.behavior.ifc.KitInteractionIfc vrStimuliOfInteractions; 
...
/****************************************************************************
 *  Constructors of the KitStimuli metamodel element
 ****************************************************************************/

  public KitStimuliBase() {
    super();
  }


  public KitStimuliBase( EAIMMCtxtIfc theCtxt) {
    super( theCtxt);
  }

  public KitStimuliBase( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theName) {
    super( theCtxt, theName);
  }


/****************************************************************************
 *  Implementation of the KitStimuliIfc and KitStimuliPriv interfaces
 ****************************************************************************/

/****************************************************************************
 *  Implementation of attributes of KitStimuli
 ****************************************************************************/
...
/****************************************************************************
 *  Implementation of relationships of KitStimuli
 ****************************************************************************/

 

/****************************************************************************
 *  Implementation of public interface for ONE relationship StimuliOfInteractions
 ****************************************************************************/
  ...
  public com.dosmil_e.kit.core.model.behavior.ifc.KitInteractionIfc getStimuliOfInteractions( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions == null) { return null;}

    try { return (com.dosmil_e.kit.core.model.behavior.ifc.KitInteractionIfc)
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions).
  ...
  public int numStimuliOfInteractions( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions == null) { return  0;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions).
  ...
  public boolean hasStimuliOfInteractionsNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions == null) { return  false;}
  ...
  public boolean hasStimuliOfInteractions( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.behavior.ifc.KitInteractionIfc theStimuliOfInteractions) throws EAIException {
    ...
    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions).
          hasRelatedElement( theCtxt, this, theStimuliOfInteractions);
    } catch( ClassCastException anEx) { return false;}
  }
  ...
  public int indexOfStimuliOfInteractions( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.behavior.ifc.KitInteractionIfc theStimuliOfInteractions) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions == null) { return  -1;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions).
          indexOfRelatedElement( theCtxt, this, theStimuliOfInteractions);
  ...
  public void setStimuliOfInteractions( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.behavior.ifc.KitInteractionIfc theStimuliOfInteractions) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions == null) { return;}

    try {
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.vm3RelStimuliOfInteractions).
        setRelatedElement( theCtxt, this, theStimuliOfInteractions);
...
/****************************************************************************
 *  Implementation of destructor of KitStimuli
 ****************************************************************************/
 ...
 ****************************************************************************/
  public static com.dosmil_e.m3.core.ifc.M3TypeIfc getStaticM3Type( EAIMMCtxtIfc theCtxt) {
    if( vm3Type == null) {
      vm3Type = com.dosmil_e.kit.core.model.behavior.meta.KitStimuliMeta.getStaticM3Type( theCtxt);
    }
    return vm3Type;
  }
