...
public  class KitDependencyOwnerMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("DependencyOwner"));
		...
		vm3RelOwnedDependencies = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedDependencies"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedDependencies);
		vm3RelOwnedDependencies.setKind( theCtxt, "Aggregates");
		vm3RelOwnedDependencies.setMinMult( theCtxt, "0");
		vm3RelOwnedDependencies.setMaxMult( theCtxt, "*");
		vm3RelOwnedDependencies.setIsDerived( theCtxt, false);
		vm3RelOwnedDependencies.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedDependencies.setInverse( theCtxt, com.dosmil_e.kit.core.model.observe.meta.KitDependencyMeta.vm3RelDependencyOwner);
		vm3RelOwnedDependencies.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.observe.meta.KitDependencyMeta.vm3Type);
