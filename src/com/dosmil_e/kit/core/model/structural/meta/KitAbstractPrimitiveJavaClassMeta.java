...
public  class KitAbstractPrimitiveJavaClassMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("AbstractPrimitiveJavaClass"));
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		vm3Type.addSuperTypes( theCtxt, com.dosmil_e.kit.core.model.structural.meta.KitPrimitiveTypeMeta.vm3Type);
		vm3Type.addSuperTypes( theCtxt, com.dosmil_e.kit.core.model.structural.meta.KitNativeResourceMeta.vm3Type);


		vm3AttrFullyQualifiedClassName = com.dosmil_e.kit.core.model.structural.meta.KitNativeResourceMeta.vm3AttrFullyQualifiedClassName;
