 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("Delegate"));
		...
		vm3RelDelegateOf = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("delegateOf"));
		vm3Type.addRelationships( theCtxt, vm3RelDelegateOf);
		vm3RelDelegateOf.setKind( theCtxt, "Many");
		vm3RelDelegateOf.setMinMult( theCtxt, "0");
		vm3RelDelegateOf.setMaxMult( theCtxt, "*");
		vm3RelDelegateOf.setIsDerived( theCtxt, false);
		vm3RelDelegateOf.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelDelegateOf.setInverse( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitDelegationMeta.vm3RelDelegate);
		vm3RelDelegateOf.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitDelegationMeta.vm3Type);
