 ...
 ****************************************************************************/
	public static com.dosmil_e.m3.core.ifc.M3RelationshipIfc vm3RelAttachements;
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		...
		vm3RelAttachements = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("attachements"));
		vm3Type.addRelationships( theCtxt, vm3RelAttachements);
		vm3RelAttachements.setKind( theCtxt, "Aggregates");
		vm3RelAttachements.setMinMult( theCtxt, "0");
		vm3RelAttachements.setMaxMult( theCtxt, "*");
		vm3RelAttachements.setIsDerived( theCtxt, false);
		vm3RelAttachements.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelAttachements.setInverse( theCtxt, com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner);
		vm3RelAttachements.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3Type);
