...
public  class KitInteractionOwnerMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("InteractionOwner"));
		...
		vm3RelOwnedInteractions = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedInteractions"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedInteractions);
		vm3RelOwnedInteractions.setKind( theCtxt, "Aggregates");
		vm3RelOwnedInteractions.setMinMult( theCtxt, "0");
		vm3RelOwnedInteractions.setMaxMult( theCtxt, "*");
		vm3RelOwnedInteractions.setIsDerived( theCtxt, false);
		vm3RelOwnedInteractions.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedInteractions.setInverse( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitInteractionMeta.vm3RelInteractionOwner);
		vm3RelOwnedInteractions.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitInteractionMeta.vm3Type);
