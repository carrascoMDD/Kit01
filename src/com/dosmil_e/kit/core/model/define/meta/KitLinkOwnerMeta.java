 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("LinkOwner"));
		...
		vm3RelOwnedLinks = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedLinks"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedLinks);
		vm3RelOwnedLinks.setKind( theCtxt, "Aggregates");
		vm3RelOwnedLinks.setMinMult( theCtxt, "0");
		vm3RelOwnedLinks.setMaxMult( theCtxt, "*");
		vm3RelOwnedLinks.setIsDerived( theCtxt, false);
		vm3RelOwnedLinks.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedLinks.setInverse( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitAbstractLinkMeta.vm3RelLinkOwner);
		vm3RelOwnedLinks.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitAbstractLinkMeta.vm3Type);
