...
public  class KitAssemblyOwnerMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("AssemblyOwner"));
		...
		vm3RelOwnedAssemblies = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedAssemblies"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedAssemblies);
		vm3RelOwnedAssemblies.setKind( theCtxt, "Aggregates");
		vm3RelOwnedAssemblies.setMinMult( theCtxt, "0");
		vm3RelOwnedAssemblies.setMaxMult( theCtxt, "*");
		vm3RelOwnedAssemblies.setIsDerived( theCtxt, false);
		vm3RelOwnedAssemblies.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedAssemblies.setInverse( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitAbstractAssemblyMeta.vm3RelAssemblyOwner);
		vm3RelOwnedAssemblies.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitAbstractAssemblyMeta.vm3Type);
