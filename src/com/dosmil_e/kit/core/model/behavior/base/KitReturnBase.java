...
public  class KitReturnBase 
   extends com.dosmil_e.kit.core.model.structural.impl.KitInfoTypeOwnerImpl
    implements com.dosmil_e.kit.core.model.behavior.ifc.KitReturnIfc   {
...
/****************************************************************************
 *  State storage for Attributes of the KitReturn metamodel element
 ****************************************************************************/



/****************************************************************************
 *  State storage for the Relationships of the KitReturn metamodel element
 ****************************************************************************/
	protected com.dosmil_e.kit.core.model.behavior.ifc.KitBidirectionalInteractionIfc vrReturnOfInteractions; 
...
/****************************************************************************
 *  Constructors of the KitReturn metamodel element
 ****************************************************************************/

  public KitReturnBase() {
    super();
  }


  public KitReturnBase( EAIMMCtxtIfc theCtxt) {
    super( theCtxt);
  }

  public KitReturnBase( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theName) {
    super( theCtxt, theName);
  }


/****************************************************************************
 *  Implementation of the KitReturnIfc and KitReturnPriv interfaces
 ****************************************************************************/

/****************************************************************************
 *  Implementation of attributes of KitReturn
 ****************************************************************************/
...
/****************************************************************************
 *  Implementation of relationships of KitReturn
 ****************************************************************************/

 

/****************************************************************************
 *  Implementation of public interface for ONE relationship ReturnOfInteractions
 ****************************************************************************/
  ...
  public com.dosmil_e.kit.core.model.behavior.ifc.KitBidirectionalInteractionIfc getReturnOfInteractions( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions == null) { return null;}

    try { return (com.dosmil_e.kit.core.model.behavior.ifc.KitBidirectionalInteractionIfc)
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions).
  ...
  public int numReturnOfInteractions( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions == null) { return  0;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions).
  ...
  public com.dosmil_e.kit.core.model.behavior.ifc.KitBidirectionalInteractionIfc findReturnOfInteractionsNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    try {
      return (com.dosmil_e.kit.core.model.behavior.ifc.KitBidirectionalInteractionIfc)
        ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions).
  ...
  public boolean hasReturnOfInteractionsNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions == null) { return  false;}
  ...
  public boolean hasReturnOfInteractions( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.behavior.ifc.KitBidirectionalInteractionIfc theReturnOfInteractions) throws EAIException {
    ...
    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions).
          hasRelatedElement( theCtxt, this, theReturnOfInteractions);
    } catch( ClassCastException anEx) { return false;}
  }
  ...
  public int indexOfReturnOfInteractions( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.behavior.ifc.KitBidirectionalInteractionIfc theReturnOfInteractions) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions == null) { return  -1;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions).
          indexOfRelatedElement( theCtxt, this, theReturnOfInteractions);
  ...
  public void setReturnOfInteractions( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.behavior.ifc.KitBidirectionalInteractionIfc theReturnOfInteractions) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions == null) { return;}

    try {
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.vm3RelReturnOfInteractions).
        setRelatedElement( theCtxt, this, theReturnOfInteractions);
...
/****************************************************************************
 *  Implementation of destructor of KitReturn
 ****************************************************************************/
 ...
 ****************************************************************************/
  public static com.dosmil_e.m3.core.ifc.M3TypeIfc getStaticM3Type( EAIMMCtxtIfc theCtxt) {
    if( vm3Type == null) {
      vm3Type = com.dosmil_e.kit.core.model.behavior.meta.KitReturnMeta.getStaticM3Type( theCtxt);
    }
    return vm3Type;
  }
