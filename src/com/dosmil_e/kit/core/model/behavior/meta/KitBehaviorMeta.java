 ...
 ****************************************************************************/
	public static com.dosmil_e.m3.core.ifc.M3RelationshipIfc vm3RelBehaviorOwner;
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("Behavior"));
		...
		vm3RelBehaviorOwner = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("behaviorOwner"));
		vm3Type.addRelationships( theCtxt, vm3RelBehaviorOwner);
		vm3RelBehaviorOwner.setKind( theCtxt, "IsPartOf");
		vm3RelBehaviorOwner.setMinMult( theCtxt, "1");
		vm3RelBehaviorOwner.setMaxMult( theCtxt, "1");
		vm3RelBehaviorOwner.setIsDerived( theCtxt, false);
		vm3RelBehaviorOwner.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelBehaviorOwner.setInverse( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitBehaviorOwnerMeta.vm3RelOwnedBehaviors);
		vm3RelBehaviorOwner.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitBehaviorOwnerMeta.vm3Type);
