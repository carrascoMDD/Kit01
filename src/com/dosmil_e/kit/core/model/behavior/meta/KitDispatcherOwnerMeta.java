...
public  class KitDispatcherOwnerMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("DispatcherOwner"));
		...
		vm3RelOwnedDispatchers = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedDispatchers"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedDispatchers);
		vm3RelOwnedDispatchers.setKind( theCtxt, "Aggregates");
		vm3RelOwnedDispatchers.setMinMult( theCtxt, "0");
		vm3RelOwnedDispatchers.setMaxMult( theCtxt, "*");
		vm3RelOwnedDispatchers.setIsDerived( theCtxt, false);
		vm3RelOwnedDispatchers.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedDispatchers.setInverse( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitDispatcherMeta.vm3RelDispatcherOwner);
		vm3RelOwnedDispatchers.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitDispatcherMeta.vm3Type);
