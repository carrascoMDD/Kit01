...
public  class KitDelegationOwnerMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("DelegationOwner"));
		...
		vm3RelOwnedDelegations = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedDelegations"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedDelegations);
		vm3RelOwnedDelegations.setKind( theCtxt, "Aggregates");
		vm3RelOwnedDelegations.setMinMult( theCtxt, "0");
		vm3RelOwnedDelegations.setMaxMult( theCtxt, "*");
		vm3RelOwnedDelegations.setIsDerived( theCtxt, false);
		vm3RelOwnedDelegations.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedDelegations.setInverse( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitDelegationMeta.vm3RelDelegationOwner);
		vm3RelOwnedDelegations.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitDelegationMeta.vm3Type);
