...
public  class KitHandlerOwnerMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("HandlerOwner"));
		...
		vm3RelOwnedHandlers = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedHandlers"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedHandlers);
		vm3RelOwnedHandlers.setKind( theCtxt, "Aggregates");
		vm3RelOwnedHandlers.setMinMult( theCtxt, "0");
		vm3RelOwnedHandlers.setMaxMult( theCtxt, "*");
		vm3RelOwnedHandlers.setIsDerived( theCtxt, false);
		vm3RelOwnedHandlers.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedHandlers.setInverse( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitHandlerMeta.vm3RelHandlerOwner);
		vm3RelOwnedHandlers.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.behavior.meta.KitHandlerMeta.vm3Type);
