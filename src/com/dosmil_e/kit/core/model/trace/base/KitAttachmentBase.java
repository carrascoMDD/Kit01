...
public  class KitAttachmentBase 
   extends com.dosmil_e.kit.core.model.common.impl.KitCommonImpl
    implements com.dosmil_e.kit.core.model.trace.ifc.KitAttachmentIfc   {
...
/****************************************************************************
 *  State storage for Attributes of the KitAttachment metamodel element
 ****************************************************************************/



/****************************************************************************
 *  State storage for the Relationships of the KitAttachment metamodel element
 ****************************************************************************/
	protected com.dosmil_e.kit.core.model.trace.ifc.KitCommentIfc vrAttachmentOwner; 
...
/****************************************************************************
 *  Constructors of the KitAttachment metamodel element
 ****************************************************************************/

  public KitAttachmentBase() {
    super();
  }


  public KitAttachmentBase( EAIMMCtxtIfc theCtxt) {
    super( theCtxt);
  }

  public KitAttachmentBase( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theName) {
    super( theCtxt, theName);
  }


/****************************************************************************
 *  Implementation of the KitAttachmentIfc and KitAttachmentPriv interfaces
 ****************************************************************************/

/****************************************************************************
 *  Implementation of attributes of KitAttachment
 ****************************************************************************/
...
/****************************************************************************
 *  Implementation of relationships of KitAttachment
 ****************************************************************************/

 

/****************************************************************************
 *  Implementation of public interface for ONE relationship AttachmentOwner
 ****************************************************************************/
  ...
  public com.dosmil_e.kit.core.model.trace.ifc.KitCommentIfc getAttachmentOwner( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner == null) { return null;}

    try { return (com.dosmil_e.kit.core.model.trace.ifc.KitCommentIfc)
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner).
  ...
  public int numAttachmentOwner( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner == null) { return  0;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner).
  ...
  public com.dosmil_e.kit.core.model.trace.ifc.KitCommentIfc findAttachmentOwnerNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    try {
      return (com.dosmil_e.kit.core.model.trace.ifc.KitCommentIfc)
        ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner).
  ...
  public boolean hasAttachmentOwnerNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner == null) { return  false;}
  ...
  public boolean hasAttachmentOwner( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.trace.ifc.KitCommentIfc theAttachmentOwner) throws EAIException {
    ...
    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner).
          hasRelatedElement( theCtxt, this, theAttachmentOwner);
    } catch( ClassCastException anEx) { return false;}
  }
  ...
  public int indexOfAttachmentOwner( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.trace.ifc.KitCommentIfc theAttachmentOwner) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner == null) { return  -1;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner).
          indexOfRelatedElement( theCtxt, this, theAttachmentOwner);
  ...
  public void setAttachmentOwner( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.model.trace.ifc.KitCommentIfc theAttachmentOwner) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner == null) { return;}

    try {
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.vm3RelAttachmentOwner).
        setRelatedElement( theCtxt, this, theAttachmentOwner);
...
/****************************************************************************
 *  Implementation of destructor of KitAttachment
 ****************************************************************************/
 ...
 ****************************************************************************/
  public static com.dosmil_e.m3.core.ifc.M3TypeIfc getStaticM3Type( EAIMMCtxtIfc theCtxt) {
    if( vm3Type == null) {
      vm3Type = com.dosmil_e.kit.core.model.trace.meta.KitAttachmentMeta.getStaticM3Type( theCtxt);
    }
    return vm3Type;
  }
