...
public  class KitInfoTypeOwnerMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("InfoTypeOwner"));
		...
		vm3RelOwnedInfoTypes = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedInfoTypes"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedInfoTypes);
		vm3RelOwnedInfoTypes.setKind( theCtxt, "Aggregates");
		vm3RelOwnedInfoTypes.setMinMult( theCtxt, "0");
		vm3RelOwnedInfoTypes.setMaxMult( theCtxt, "*");
		vm3RelOwnedInfoTypes.setIsDerived( theCtxt, false);
		vm3RelOwnedInfoTypes.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedInfoTypes.setInverse( theCtxt, com.dosmil_e.kit.core.model.structural.meta.KitInfoTypeMeta.vm3RelInfoTypeOwner);
		vm3RelOwnedInfoTypes.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.structural.meta.KitInfoTypeMeta.vm3Type);
