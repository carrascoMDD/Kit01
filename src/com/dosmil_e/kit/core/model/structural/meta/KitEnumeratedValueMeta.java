...
public  class KitEnumeratedValueMeta {
 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("EnumeratedValue"));
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelType.setInverse( theCtxt, com.dosmil_e.kit.core.model.structural.meta.KitAbstractEnumeratedTypeMeta.vm3RelEnumeratedValues);
		vm3RelType.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.structural.meta.KitAbstractEnumeratedTypeMeta.vm3Type);
