...
public  class KitFachadeBase 
   extends com.dosmil_e.kit.core.projection.projecting.impl.KitProjectionImpl
    implements com.dosmil_e.kit.core.projection.projecting.ifc.KitFachadeIfc   {
...
/****************************************************************************
 *  State storage for Attributes of the KitFachade metamodel element
 ****************************************************************************/



/****************************************************************************
 *  State storage for the Relationships of the KitFachade metamodel element
 ****************************************************************************/
	protected com.dosmil_e.kit.core.projection.projecting.ifc.KitProjectedIfc vrProjected; 
...
/****************************************************************************
 *  Constructors of the KitFachade metamodel element
 ****************************************************************************/

  public KitFachadeBase() {
    super();
  }


  public KitFachadeBase( EAIMMCtxtIfc theCtxt) {
    super( theCtxt);
  }

  public KitFachadeBase( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theName) {
    super( theCtxt, theName);
  }


/****************************************************************************
 *  Implementation of the KitFachadeIfc and KitFachadePriv interfaces
 ****************************************************************************/

/****************************************************************************
 *  Implementation of attributes of KitFachade
 ****************************************************************************/
...
/****************************************************************************
 *  Implementation of relationships of KitFachade
 ****************************************************************************/

 

/****************************************************************************
 *  Implementation of public interface for ONE relationship Projected
 ****************************************************************************/
  ...
  public com.dosmil_e.kit.core.projection.projecting.ifc.KitProjectedIfc getProjected( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected == null) { return null;}

    try { return (com.dosmil_e.kit.core.projection.projecting.ifc.KitProjectedIfc)
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected).
  ...
  public int numProjected( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected == null) { return  0;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected).
  ...
  public com.dosmil_e.kit.core.projection.projecting.ifc.KitProjectedIfc findProjectedNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    try {
      return (com.dosmil_e.kit.core.projection.projecting.ifc.KitProjectedIfc)
        ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected).
  ...
  public boolean hasProjectedNamed( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theMMName) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected == null) { return  false;}
  ...
  public boolean hasProjected( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.projection.projecting.ifc.KitProjectedIfc theProjected) throws EAIException {
    ...
    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected).
          hasRelatedElement( theCtxt, this, theProjected);
    } catch( ClassCastException anEx) { return false;}
  }
  ...
  public int indexOfProjected( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.projection.projecting.ifc.KitProjectedIfc theProjected) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected == null) { return  -1;}

    try {
      return ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected).
          indexOfRelatedElement( theCtxt, this, theProjected);
  ...
  public void setProjected( EAIMMCtxtIfc theCtxt, com.dosmil_e.kit.core.projection.projecting.ifc.KitProjectedIfc theProjected) throws EAIException {
    ...
    getM3Type( theCtxt);
    if( com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected == null) { return;}

    try {
      ((com.dosmil_e.m3.core.pub.M3RelationshipPub) com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.vm3RelProjected).
        setRelatedElement( theCtxt, this, theProjected);
...
/****************************************************************************
 *  Implementation of destructor of KitFachade
 ****************************************************************************/
 ...
 ****************************************************************************/
  public static com.dosmil_e.m3.core.ifc.M3TypeIfc getStaticM3Type( EAIMMCtxtIfc theCtxt) {
    if( vm3Type == null) {
      vm3Type = com.dosmil_e.kit.core.projection.projecting.meta.KitFachadeMeta.getStaticM3Type( theCtxt);
    }
    return vm3Type;
  }
