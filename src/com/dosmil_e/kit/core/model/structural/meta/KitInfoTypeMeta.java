 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("InfoType"));
		...
		vm3RelInfoTypeOwner = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("infoTypeOwner"));
		vm3Type.addRelationships( theCtxt, vm3RelInfoTypeOwner);
		vm3RelInfoTypeOwner.setKind( theCtxt, "IsPartOf");
		vm3RelInfoTypeOwner.setMinMult( theCtxt, "1");
		vm3RelInfoTypeOwner.setMaxMult( theCtxt, "1");
		vm3RelInfoTypeOwner.setIsDerived( theCtxt, false);
		vm3RelInfoTypeOwner.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelInfoTypeOwner.setInverse( theCtxt, com.dosmil_e.kit.core.model.structural.meta.KitInfoTypeOwnerMeta.vm3RelOwnedInfoTypes);
		vm3RelInfoTypeOwner.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.structural.meta.KitInfoTypeOwnerMeta.vm3Type);
