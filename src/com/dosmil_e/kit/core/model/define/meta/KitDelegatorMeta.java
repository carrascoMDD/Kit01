 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("Delegator"));
		...
		vm3RelDelegatorOf = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("delegatorOf"));
		vm3Type.addRelationships( theCtxt, vm3RelDelegatorOf);
		vm3RelDelegatorOf.setKind( theCtxt, "Many");
		vm3RelDelegatorOf.setMinMult( theCtxt, "0");
		vm3RelDelegatorOf.setMaxMult( theCtxt, "*");
		vm3RelDelegatorOf.setIsDerived( theCtxt, false);
		vm3RelDelegatorOf.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelDelegatorOf.setInverse( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitDelegationMeta.vm3RelDelegator);
		vm3RelDelegatorOf.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitDelegationMeta.vm3Type);
