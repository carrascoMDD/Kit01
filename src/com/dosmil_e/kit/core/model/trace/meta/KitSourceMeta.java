 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("Source"));
		...
		vm3RelSourceOfAnnnotations = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("sourceOfAnnnotations"));
		vm3Type.addRelationships( theCtxt, vm3RelSourceOfAnnnotations);
		vm3RelSourceOfAnnnotations.setKind( theCtxt, "Many");
		vm3RelSourceOfAnnnotations.setMinMult( theCtxt, "0");
		vm3RelSourceOfAnnnotations.setMaxMult( theCtxt, "*");
		vm3RelSourceOfAnnnotations.setIsDerived( theCtxt, false);
		vm3RelSourceOfAnnnotations.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelSourceOfAnnnotations.setInverse( theCtxt, com.dosmil_e.kit.core.model.trace.meta.KitAnnotationMeta.vm3RelSources);
		vm3RelSourceOfAnnnotations.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.trace.meta.KitAnnotationMeta.vm3Type);
