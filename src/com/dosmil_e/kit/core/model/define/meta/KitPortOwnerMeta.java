 ...
 ****************************************************************************/
  public static void initM3TypePhase1( EAIMMCtxtIfc theCtxt) throws EAIException {
		 vm3Type = (com.dosmil_e.m3.core.ifc.M3TypeIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Type", "core",new EAIMMName("PortOwner"));
		...
		vm3RelOwnedPorts = (com.dosmil_e.m3.core.ifc.M3RelationshipIfc) theCtxt.getMMFactory("M3").createMMElementOfType( theCtxt, "Relationship", "core",new EAIMMName("ownedPorts"));
		vm3Type.addRelationships( theCtxt, vm3RelOwnedPorts);
		vm3RelOwnedPorts.setKind( theCtxt, "Aggregates");
		vm3RelOwnedPorts.setMinMult( theCtxt, "0");
		vm3RelOwnedPorts.setMaxMult( theCtxt, "*");
		vm3RelOwnedPorts.setIsDerived( theCtxt, false);
		vm3RelOwnedPorts.setIsDummy( theCtxt, false);
 ...
 ****************************************************************************/
  public static void initM3TypePhase2( EAIMMCtxtIfc theCtxt)  throws EAIException {
		...
		vm3RelOwnedPorts.setInverse( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitAbstractPortMeta.vm3RelPortOwner);
		vm3RelOwnedPorts.setRelatedType( theCtxt, com.dosmil_e.kit.core.model.define.meta.KitAbstractPortMeta.vm3Type);
